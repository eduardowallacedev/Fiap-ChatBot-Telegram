...
public class ModificarConta implements Opcoes {
	...
	private void mostrarMenu(Cliente cliente) {
		...
		Keyboard keyboard = new ReplyKeyboardMarkup(new String[] { "nome", "cpf" },
				new String[] { "rg", "data de nascimento" });
		...
		case "data de nascimento": {
			...
			if (cliente.getMensagemAtual().trim().equals("")) {
				...
				try {
					...
					LocalDate dataNasc = LocalDate.parse(cliente.getMensagemAtual(),
